...
class __TwigTemplate_080b92b579b591625c7c994bdbae6ff07c6dbabf33eed4e70e2e79dd26628592 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["message"]) {
            ...
            echo "</td>      
                        <td>";
            // line 18
            echo twig_escape_filter($this->env, twig_date_format_filter($this->env, twig_get_attribute($this->env, $this->source, $context["message"], "sendAT", [], "any", false, false, false, 18), "d/m/Y H:i:s "), "html", null, true);
            echo "</td>   
                    </tr>
                ";
        }
            ...
            <tbody>
                {% for message in messages %}
                    <tr>
                        ...
                        <td>{{message.motif}}</td>      
                        <td>{{message.sendAT|date('d/m/Y H:i:s ' )}}</td>   
                    </tr>
                {% endfor%}
